...
The AI Startup Game places students in the role of an AI startup founder making real strategic decisions under uncertainty. Over 3-4 simulated years, players must:
...
BibTeX:
```bibtex
@software{salter2025aistartupgame,
...
The AI Startup Game is **educational software** designed solely for teaching and learning purposes. It is intended to illustrate concepts in entrepreneurship, innovation management, and technology strategy in an engaging, experiential format.
...
### AI Collaboration
Development assisted by Claude (Anthropic), Gemini (Google), and ChatGPT (OpenAI).
